...
merge 1:1 patient_id flag using "data/cohort_`outcome'_control_2020"
keep if _merge ==3
drop _merge

gen matchedFlag = 1 
save "data/cr_matches_long_control_2020_`outcome'.dta", replace
erase "data/cr_matches_control_2020_`outcome'.dta"
...
bysort setid: replace indexdate = index2020 if indexdate==.
drop indexCovid index2020
